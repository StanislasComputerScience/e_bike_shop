...
def create_table_db(ecommerce_db_dict: dict):
    ...
    ecommerce_db_dict["create table Role"] = \
        """CREATE TABLE IF NOT EXISTS Role (
            ...
            name TEXT NOT NULL);"""
    ecommerce_db_dict["create table Connection"] = \
...
def create_insert_into_tables(ecommerce_db_dict: dict):
    ecommerce_db_dict["insert into Role: user"] = \
        """INSERT INTO Role(name)
            VALUES('user');
        """
    ecommerce_db_dict["insert into Role: admin"] = \
        """INSERT INTO Role(name)
            VALUES('admin');
        """
    ecommerce_db_dict["insert into Connection: timeout"] = \
        """INSERT INTO Connection(status)
            VALUES('timeout');
        """
    ecommerce_db_dict["insert into Connection: pending"] = \
        """INSERT INTO Connection(status)
            VALUES('pending');
        """
    ecommerce_db_dict["insert into Connection: connected"] = \
        """INSERT INTO Connection(status)
            VALUES('connected');
        """
